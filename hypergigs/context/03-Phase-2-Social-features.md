...
#### high priortiy
- Private talent book through bookmarking / add to talent book for later hiring
- Share talent book within own company page that will show teams such as marketing, IT, Design, UX, Development, Social etc dashboard but option to hide for specific teams
- Show their team members profile cards at the bottom of the user profile detail page
- Show teams cards that they are part of at the bottom of the team detail page p


#### medium priortiy

- Build real-time messaging with Socket.io for connected users only once their invitation accepted
- Implement team messaging channels
- Implement follow/unfollow for accepted users that were outside the team before and also within the same team member
- Create notification system
- social media links option for users under social media links option for users profile detail page and freelancer listpage profile cards under the Bio. It can take Linkedin, Instagram, Twitter X, Behance, Github, user own website url (multiple url options). 


#### low priortiy
- Develop activity feed
- Add client reference feature where talent can request their client to provide reference and feedback
